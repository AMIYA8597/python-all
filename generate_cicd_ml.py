...
filepath = r"d:\work\python-all\19-MLOps-and-Deployment\05_ci_cd_for_ml.md"
os.makedirs(os.path.dirname(filepath), exist_ok=True)

markdown_content = """# Continuous Integration and Continuous Deployment (CI/CD) for Machine Learning

...
markdown_text = """# Chapter 5: Building the Autonomous Agent
...
file_path = r"d:\work\python-all\18-Agentic-AI\05_building_autonomous_agent.md"
...
print(f"Successfully wrote {word_count} words to {file_path}")

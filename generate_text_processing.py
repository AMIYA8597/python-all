...
file_path = r"d:\work\python-all\16-Deep-Learning-and-CV-NLP\05_nlp_text_processing.md"
os.makedirs(os.path.dirname(file_path), exist_ok=True)

sections = []

sections.append(r"""# Classical NLP Text Processing: A Comprehensive Guide

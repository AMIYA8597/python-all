...
output_file = r"d:\work\python-all\07-Interview-Preparation\01-Theory\03-Prob-Patterns.md"

intro = """# Comprehensive Guide to the 14 Fundamental Algorithmic Patterns
...
content = intro + sliding_window + two_pointers + fast_slow + merge_intervals + cyclic_sort + inplace_rev + tree_bfs + tree_dfs + two_heaps + subsets + modified_bs + top_k + k_way + topological

...
markdown_content = """# Model Serving with FastAPI: A Deep Dive into Production Machine Learning APIs
...
file_path = r"d:\work\python-all\19-MLOps-and-Deployment\02_model_serving_fastapi.md"

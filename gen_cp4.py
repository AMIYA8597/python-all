...
md_content = r"""# COMMON MISTAKES AND DEADLY TRAPS IN COMPETITIVE PROGRAMMING
...
with open(r"d:\work\python-all\05-Competitive-Programming\01-Theory\04-Common-Mistakes.md", "w", encoding="utf-8") as f:
    f.write(md_content)
    
print("Successfully generated 04-Common-Mistakes.md")

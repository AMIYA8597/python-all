...
target_path = r"d:\work\python-all\16-Deep-Learning-and-CV-NLP\10_cv_convolutional_neural_networks.md"
os.makedirs(os.path.dirname(target_path), exist_ok=True)

markdown_content = r'''# Deep Learning for Computer Vision: Convolutional Neural Networks (CNNs)
...
print(f"Generated text with length {len(markdown_content.split())} words.")
print("Markdown generated and written successfully!")

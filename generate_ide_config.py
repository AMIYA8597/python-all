...
file_path = r"d:\work\python-all\12-Resources-References\03-Tools-Env\02-ide-config.md"

os.makedirs(os.path.dirname(file_path), exist_ok=True)

markdown_content = """# Advanced IDE Configurations for Python Development

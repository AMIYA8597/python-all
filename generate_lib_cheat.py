...
filepath = r"d:\work\python-all\12-Resources-References\01-Documentation\02-Lib-Cheat.md"
os.makedirs(os.path.dirname(filepath), exist_ok=True)

sections = []

sections.append(r"""# Python Standard Library and Ecosystem Master Cheat Sheet

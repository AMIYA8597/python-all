...
file_path = r"d:\work\python-all\22-AI-Evaluation-and-Safety\02_rag_and_generation_evaluation.md"
os.makedirs(os.path.dirname(file_path), exist_ok=True)

markdown_text = """# Retrieval-Augmented Generation (RAG) and Generation Evaluation: A Comprehensive Textbook Guide
...
print(f"Successfully wrote {len(markdown_text.split())} words to {file_path}")

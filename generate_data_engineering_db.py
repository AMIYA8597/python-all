...
markdown_content = r"""# Chapter 23.1: Databases in Data Engineering: SQL, NoSQL, and Beyond
...
file_path = r"d:\work\python-all\23-Data-Engineering-and-Cloud\01-Databases-SQL-NoSQL.md"
os.makedirs(os.path.dirname(file_path), exist_ok=True)
with open(file_path, "w", encoding="utf-8") as f:
    f.write(markdown_content)
print("Data engineering markdown generated successfully at", file_path)

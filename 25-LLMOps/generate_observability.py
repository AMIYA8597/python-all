...
filepath = r"d:\work\python-all\25-LLMOps\03_Observability.md"
os.makedirs(os.path.dirname(filepath), exist_ok=True)

markdown_content = """# Chapter 3: LLM Observability in Production
...
print("Observability documentation generated successfully.")

# Agentic AI: The Mechanics of Native Tool Calling
...
## 3. Anatomy of a Tool Call: JSON Schema and API Contracts
...
## 4. The Lifecycle of a Tool Call: From Request to Execution
...
## 5. Inside the Model: How LLMs Decide to Halt and Use Tools
...
## 6. The OpenAI API Specification for Function Calling
...
## 7. Handling Tool Execution Results
...
## 8. Security Implications: Prompt Injection and Unauthorized Execution
...
## 9. Advanced Patterns: Parallel Tool Calling and Chaining

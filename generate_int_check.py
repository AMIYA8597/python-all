...
markdown_content = """# Master FAANG Interview Checklist and Cheat Sheet
...
import os
filepath = "d:/work/python-all/12-Resources-References/01-Documentation/05-Int-Check.md"
os.makedirs(os.path.dirname(filepath), exist_ok=True)
with open(filepath, "w", encoding="utf-8") as f:
    f.write(markdown_content)
print("SUCCESS: File successfully written to " + filepath)

...
md_content = r"""# TIME MANAGEMENT AND STUDY ARCHITECTURE
...
with open(r"d:\work\python-all\05-Competitive-Programming\01-Theory\03-Time-Mgmt.md", "w", encoding="utf-8") as f:
    f.write(md_content)
    
print("Successfully generated 03-Time-Mgmt.md")

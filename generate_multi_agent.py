...
content = """# Multi-Agent Systems: Architecting Distributed AI Teams
...
file_path = r"d:\work\python-all\18-Agentic-AI\04_multi_agent_systems.md"
...
print(f"Successfully wrote {len(content.split())} words to {file_path}")

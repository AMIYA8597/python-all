...
file_path = r"d:\work\python-all\25-LLMOps\01_LLM_Deployment.md"
os.makedirs(os.path.dirname(file_path), exist_ok=True)

markdown_content = """# Deep Dive: LLM Deployment at Scale
...
print(f"Successfully generated {file_path} with {len(markdown_content.split())} words.")

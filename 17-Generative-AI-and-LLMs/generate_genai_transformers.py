...
markdown_content = r'''# Generative AI and Large Language Models: The Transformer Architecture
...
file_path = r"d:\work\python-all\17-Generative-AI-and-LLMs\01_transformers.md"
os.makedirs(os.path.dirname(file_path), exist_ok=True)
with open(file_path, 'w', encoding='utf-8') as f:
    f.write(markdown_content)
    
print("Successfully generated 01_transformers.md")

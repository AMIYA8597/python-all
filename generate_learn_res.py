...
def generate_markdown():
    part1 = """# Advanced Python Learning Resources and Architect Roadmap
...
if __name__ == '__main__':
    ...
    target_path = r"d:\work\python-all\12-Resources-References\02-External-Resources\05-learn-res.md"
    ...
    print(f"File generated successfully. Word count: {word_count}")

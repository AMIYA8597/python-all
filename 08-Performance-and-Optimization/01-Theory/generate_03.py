...
file_path = os.path.join(os.path.dirname(__file__), "03-Cache-Opt.md")

parts = []

parts.append(r"""# 03 - Cache Optimization in Python: A Textbook Deep Dive
...
with open(file_path, "w", encoding="utf-8") as f:
    for part in parts:
        f.write(part)
print(f"Successfully wrote deep dive markdown to {file_path}")

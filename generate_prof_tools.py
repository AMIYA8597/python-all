...
filepath = r"d:\work\python-all\12-Resources-References\03-Tools-Env\04-prof-tools.md"
...
DD_VERSION=2.4.1 \
ddtrace-run gunicorn my_app.wsgi:application
```
...
print("Done generating markdown reference.")

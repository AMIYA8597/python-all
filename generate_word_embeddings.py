...
file_path = r"d:\work\python-all\16-Deep-Learning-and-CV-NLP\06_nlp_word_embeddings.md"

markdown_content = """# Chapter 6: Natural Language Processing - Word Embeddings
